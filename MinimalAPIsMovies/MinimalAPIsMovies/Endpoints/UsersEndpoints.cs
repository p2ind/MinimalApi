...
namespace MinimalAPIsMovies.Endpoints
{
    public static class UsersEndpoints
    {
        ...
        private static async Task<Results<NotFound, Ok<AuthenticationResponseDTO>>> ReNew(IUserService userService, IConfiguration configuration, [FromServices] UserManager<IdentityUser> userManager)
        {
