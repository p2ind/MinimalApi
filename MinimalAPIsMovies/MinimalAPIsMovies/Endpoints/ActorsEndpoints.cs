...
namespace MinimalAPIsMovies.Endpoints
{
    public static class ActorsEndpoints
    {
        ...
        static async Task<Results<NotFound,NoContent>> Update(int id, [FromForm] CreateActorDTO createActorDTO, 
            IActorsRepository repository, IFileStorage fileStorage,
            IOutputCacheStore outputCacheStore, IMapper mapper)
        {
            ...
            var actorForUpdate = mapper.Map<Actor>(actorDB);
        ...
        static async Task<Results<NotFound,NoContent>> Delete(int id, IActorsRepository repository, 
